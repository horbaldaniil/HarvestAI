...
log = logging.getLogger("train_yield_v4")

TRAINING_SET = ROOT / "data" / "processed" / "training_set_v3.parquet"
MODELS_DIR = ROOT / "models"
METRICS_OUT = ROOT / "data" / "processed" / "model_metrics_v4.json"

# 23-feature tabular schema (v4 extension).
# v3 had 17 features; v4 adds 6 crop-specific weather-derivation features
...
FEATURE_NAMES: tuple[str, ...] = (
    ...
    # v4 crop-specific extensions — 6 new features
...
def _model_filename(family: str, crop: str) -> str:
    ...
    return f"yield_{short}_{crop}_v4.joblib"

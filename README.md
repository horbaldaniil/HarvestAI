...
Курсова робота, спеціальність "F3 - Комп'ютерні науки"

Виконано студентом ПМіМ-13 Горбаль Даніїл
...
- 🤖 **Машинне навчання** — прогноз врожайності для 13 найпоширеніших культур України
